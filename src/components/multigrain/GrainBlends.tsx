    ...
    en: {
        ...
        blends: [
            ...
            },
            {
                ...
                benefit: "17–20g protein per 100g — nearly double that of regular wheat atta. Legumes are lightly roasted before milling for better digestibility.",
                forWhom: "Ideal for: Athletes, vegetarians & fitness enthusiasts",
                highlight: "Improved amino acid diversity. Thyroid caution: soy may affect thyroid function. Gout caution: chickpea may increase uric acid.",
                startingPrice: 90,
            },
            {
                emoji: "🏺",
                ...
                benefit: "100% wheat-free. Highest mineral density — ragi alone provides 344mg calcium per 100g. Suitable for gluten-sensitive individuals. Milled on shared equipment — not certified gluten‑free for diagnosed celiac disease.",
            ...
            },
            {
                ...
                highlight: "40–60% premium over standard atta — worth every grain. Anticoagulant warning: flaxseed/chia may interact with blood thinners.",
                startingPrice: 110,
            },
            {
                emoji: "🌿",
                ...
                composition: "Multigrain base + Methi 3% · Moringa 2% · Turmeric 2% · Amla 3%",
                ...
                highlight: "Consult your physician if you have a chronic condition. Pregnancy warning: fenugreek may stimulate uterine contractions.",
                startingPrice: 100,
            },
        ]
    },
    hi: {
        ...
        blends: [
            ...
            },
            {
                ...
                benefit: "17-20g प्रोटीन प्रति 100g — नियमित गेहूं के आटे से लगभग दोगुना। बेहतर पाचन के लिए पिसाई से पहले फलियों को हल्का भून लिया जाता है।",
                forWhom: "आदर्श: एथलीट, शाकाहारी और फिटनेस के प्रति उत्साही",
                highlight: "बेहतर अमीनो एसिड विविधता। थायराइड सावधानी: सोया थायराइड कार्य को प्रभावित कर सकता है। गाउट सावधानी: चना यूरिक एसिड बढ़ा सकता है।",
                startingPrice: 90,
            },
            {
                emoji: "🏺",
                ...
                benefit: "100% गेहूं-मुक्त। उच्च खनिज घनत्व - रागी अकेले 100g में 344mg कैल्शियम प्रदान करता है। ग्लूटेन-संवेदनशील व्यक्तियों के लिए उपयुक्त। साझा उपकरणों पर पिसा हुआ — सीलिएक रोग के लिए प्रमाणित ग्लूटेन-मुक्त नहीं।",
            ...
            },
            {
                ...
                highlight: "मानक आटे की तुलना में 40-60% प्रीमियम - हर कण मूल्यवान। थक्कारोधी (Anticoagulant) चेतावनी: अलसी/चिया रक्त को पतला करने वाली दवाओं के साथ परस्पर क्रिया कर सकते हैं।",
                startingPrice: 110,
            },
            {
                emoji: "🌿",
                ...
                tag: "चिकित्सकीय",
                tagStyle: "bg-accent-green/10 text-accent-green",
                composition: "मल्टीग्रेन बेस + मेथी 3% · मोरिंगा 2% · हल्दी 2% · आंवला 3%",
                benefit: "यह चिकित्सा उपचार का विकल्प नहीं है। अनुमेय सीमा के भीतर FSSAI-अनुपालन आयुर्वेदिक जड़ी-बूटियों को शामिल करता है। उच्च कोविड के बाद स्वास्थ्य जागरूकता मांग के साथ उभरती हुई श्रेणी।",
                forWhom: "आदर्श: निवारक कल्याण और लक्षित स्वास्थ्य समर्थन",
                highlight: "यदि आपको कोई पुरानी बीमारी है तो अपने चिकित्सक से परामर्श लें। गर्भावस्था चेतावनी: मेथी गर्भाशय संकुचन को उत्तेजित कर सकती है।",
                startingPrice: 100,
            },
        ]
    }

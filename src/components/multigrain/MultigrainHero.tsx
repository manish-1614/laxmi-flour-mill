...
export default function MultigrainHero() {
    ...
    const stats = [
        { value: "15+", label: t.hero.stats.premiumGrains },
        { value: "5", label: t.hero.stats.signatureBlends },
        { value: "7", label: t.hero.stats.healthFunctions },
        { value: t.hero.stats.zero, label: t.hero.stats.preservatives },
    ];
                    ...
                    <div className="max-w-2xl space-y-10">
                        ...
                        <div className="space-y-5 animate-fade-in-left">
                            <h1 className="text-5xl md:text-[5.5rem] leading-[1.02] text-dark-brown tracking-tight">
                                {t.hero.elevateEvery}
                                <span className="block italic text-wheat">{t.hero.rotiYouMake}</span>
                            </h1>
